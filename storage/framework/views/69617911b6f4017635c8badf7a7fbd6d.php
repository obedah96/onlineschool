...
url = '<?php echo rtrim($baseUrl, '/'); ?>/<?php echo e($endpoint->boundUri); ?>'
...
<?php $__currentLoopData = u::getParameterNamesAndValuesForFormData($parameter, $value); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $actualValue): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
  '<?php echo $key; ?>': (None, '<?php echo $actualValue; ?>')<?php if(!($loop->parent->last) || count($endpoint->fileParameters)): ?>,
<?php endif; ?>
...
response.json()
```
<?php /**PATH C:\xampp\htdocs\OnlineProgrammingSchool\vendor\knuckleswtf\scribe\resources\views\partials\example-requests\python.md.blade.php ENDPATH**/ ?>