            ...
            <div class="sl-mb-4">
                ...
                <?php if($metadata['postman_collection_url']): ?>
                    <a title="Download Postman collection" class="sl-mx-1"
                       href="<?php echo $metadata['postman_collection_url']; ?>" target="_blank">
                        <small>Postman collection →</small>
                    </a>
                <?php endif; ?>
                <?php if($metadata['openapi_spec_url']): ?>
                    <a title="Download OpenAPI spec" class="sl-mx-1"
                       href="<?php echo $metadata['openapi_spec_url']; ?>" target="_blank">
...
<?php /**PATH C:\xampp\htdocs\OnlineProgrammingSchool\vendor\knuckleswtf\scribe\resources\views\themes\elements\index.blade.php ENDPATH**/ ?>